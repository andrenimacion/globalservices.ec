<div class="container-fluid mt-4" id="footer">
    <div class="box-f-1" id="box-f-1" style="background-image: url('ul/footer.png');">
        <p><!--
           ...
           <div class="icos" id="icos-1">
                <img src="ul/site-ico.png" width="25px" height="30px">
                <p style="margin-top: 15px; margin-left: 10px;">Dir.: Urb. Bellavista - Mz. 62 * Solar 29</p>
           </div>
        </p>
    </div>

    <div class="box-f-1" id="box-f-2">
